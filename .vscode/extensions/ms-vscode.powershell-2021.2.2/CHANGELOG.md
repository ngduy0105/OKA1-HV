...
- 🛫 🐛 [vscode-powershell [#3181](https://github.com/PowerShell/vscode-powershell/issues/3181)](https://github.com/PowerShell/vscode-powershell/pull/3202) -
...
- 👷 🐛 [vscode-powershell [#3197](https://github.com/PowerShell/vscode-powershell/issues/3197)](https://github.com/PowerShell/vscode-powershell/pull/3197) -
  Some improvements to the release scripts.

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 📖 🐛 [PowerShellEditorServices [#1416](https://github.com/PowerShell/vscode-powershell/issues/1416)](https://github.com/PowerShell/PowerShellEditorServices/pull/1416) -
  Fix some markdownlint errors in README.
- 🛫 🐛 [PowerShellEditorServices [#1415](https://github.com/PowerShell/vscode-powershell/issues/1415)](https://github.com/PowerShell/PowerShellEditorServices/pull/1415) -
...
- 🛫 🐛 [vscode-powershell [#3132](https://github.com/PowerShell/vscode-powershell/issues/3132)](https://github.com/PowerShell/vscode-powershell/pull/3132) -
  Use new brew cask installation syntax for PowerShell installation. (Thanks @philippkahr!)
- 📺 🐛 [vscode-powershell [#3177](https://github.com/PowerShell/vscode-powershell/issues/3177)](https://github.com/PowerShell/vscode-powershell/pull/3177) -
  Disable VSCode Notebook API prototype while the API is still unstable.
- 👷 ✨ [vscode-powershell [#3162](https://github.com/PowerShell/vscode-powershell/issues/3162)](https://github.com/PowerShell/vscode-powershell/pull/3162) -
  Rewrite release signing pipeline.
- 💎 🐛 [vscode-powershell [#3129](https://github.com/PowerShell/vscode-powershell/issues/3129)](https://github.com/PowerShell/vscode-powershell/pull/3129) -
  Add braces to PSCustomObject snippet to play nice with auto-closing pairs.
- 📖 ✨ [vscode-powershell [#3152](https://github.com/PowerShell/vscode-powershell/issues/3152)](https://github.com/PowerShell/vscode-powershell/pull/3152) -
  Add @andschwa to the README as maintainer.
- 👷 🐛 [vscode-powershell [#3099](https://github.com/PowerShell/vscode-powershell/issues/3099)](https://github.com/PowerShell/vscode-powershell/pull/3099) -
  Update dependencies to fix CI on macOS.
- 🐢 🐛 [vscode-powershell [#3089](https://github.com/PowerShell/vscode-powershell/issues/3089)](https://github.com/PowerShell/vscode-powershell/pull/3089) -
  Remove hardcoded output format.
- 📖 🐛 [vscode-powershell [#3086](https://github.com/PowerShell/vscode-powershell/issues/3086)](https://github.com/PowerShell/vscode-powershell/pull/3086) -
  Fix typo in description of legacy codelens description. (Thanks @nexxai!)
- 🚂 ✨ [vscode-powershell [#3053](https://github.com/PowerShell/vscode-powershell/issues/3053)](https://github.com/PowerShell/vscode-powershell/pull/3053) -
  Use VSCode telemetry endpoint for PSES telemetry.
- 🚂 ✨ [vscode-powershell [#3047](https://github.com/PowerShell/vscode-powershell/issues/3047)](https://github.com/PowerShell/vscode-powershell/pull/3047) -
  Update language server client.
- 🐢 ✨ [vscode-powershell [#2998](https://github.com/PowerShell/vscode-powershell/issues/2998)](https://github.com/PowerShell/vscode-powershell/pull/2998) -
  Added Pester v5 support to problem matcher. (Thanks @fflaten!)
- ✂️ 🐛 [vscode-powershell [#3023](https://github.com/PowerShell/vscode-powershell/issues/3023)](https://github.com/PowerShell/vscode-powershell/pull/3023) -
  Ensure help completions only run on powershell scripts.
- 🛫 🐛 [vscode-powershell [#2973](https://github.com/PowerShell/vscode-powershell/issues/2973)](https://github.com/PowerShell/vscode-powershell/pull/2973) -
  Fix session menu fails to open when PowerShell extension is starting. (Thanks @jeffpatton1971!)

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 👷 ✨ [PowerShellEditorServices [#1408](https://github.com/PowerShell/vscode-powershell/issues/1408)](https://github.com/PowerShell/PowerShellEditorServices/pull/1408) -
  Rewrite release signing pipeline.
- 🚨 ✨ [PowerShellEditorServices [#1398](https://github.com/PowerShell/vscode-powershell/issues/1398)](https://github.com/PowerShell/PowerShellEditorServices/pull/1398) -
  Refactor e2e tests.
- 🚂 ✨ [PowerShellEditorServices [#1381](https://github.com/PowerShell/vscode-powershell/issues/1381)](https://github.com/PowerShell/PowerShellEditorServices/pull/1381) -
  Hook up Telemetry LSP event and add telemetry event when users opt-out/in to features.
- 👷 🐛 [PowerShellEditorServices [#1397](https://github.com/PowerShell/vscode-powershell/issues/1397)](https://github.com/PowerShell/PowerShellEditorServices/pull/1397) -
  More compliant NuGet.config.
- 📺 🐛 [vscode-powershell [#3071](https://github.com/PowerShell/vscode-powershell/issues/3071)](https://github.com/PowerShell/PowerShellEditorServices/pull/1394) -
  Fix [#1393](https://github.com/PowerShell/vscode-powershell/issues/1393): Always use local help to return cmdlet help text. (Thanks @deadlydog!)
- 🚂 ✨ [PowerShellEditorServices [#1376](https://github.com/PowerShell/vscode-powershell/issues/1376)](https://github.com/PowerShell/PowerShellEditorServices/pull/1376) -
  Move to Omnisharp lib 0.18.x.
- 🛫 🐛 [vscode-powershell [#2965](https://github.com/PowerShell/vscode-powershell/issues/2965)](https://github.com/PowerShell/PowerShellEditorServices/pull/1363) -
  Fix error when started in low .NET versions.
- 📖 🐛 [PowerShellEditorServices [#1364](https://github.com/PowerShell/vscode-powershell/issues/1364)](https://github.com/PowerShell/PowerShellEditorServices/pull/1364) -
...
- 📺✨ [vscode-powershell [#2919](https://github.com/PowerShell/vscode-powershell/issues/2919)](https://github.com/PowerShell/vscode-powershell/pull/2919) -
  Create new Untitled Notebooks and support for Automatic Notebooks (`*.Notebook.ps1`).
- 📺✨ [vscode-powershell [#2935](https://github.com/PowerShell/vscode-powershell/issues/2935)](https://github.com/PowerShell/vscode-powershell/pull/2935) -
  Add ISE theme settings borders. (Thanks @CalistusK!)
- 👷✨ [vscode-powershell [#2922](https://github.com/PowerShell/vscode-powershell/issues/2922)](https://github.com/PowerShell/vscode-powershell/pull/2922) -
  Add editorconfig to recommended extensions for the local build. (Thanks @xtqqczze!)
- 👷✨ [vscode-powershell [#2889](https://github.com/PowerShell/vscode-powershell/issues/2889)](https://github.com/PowerShell/vscode-powershell/pull/2889) -
  Use spaces instead of tabs for consistency. (Thanks @xtqqczze!)
- 👷✨ [vscode-powershell [#2884](https://github.com/PowerShell/vscode-powershell/issues/2884)](https://github.com/PowerShell/vscode-powershell/pull/2884) -
  Update copyright header in *.ps1, *.psm1 files. (Thanks @xtqqczze!)
- 🐢🐛 [vscode-powershell [#2888](https://github.com/PowerShell/vscode-powershell/issues/2888)](https://github.com/PowerShell/vscode-powershell/pull/2888) -
  Fixed crash when running pester older than 3.4.5. (Thanks @EmmanuelPineiro!)
- 👷✨ [vscode-powershell [#2881](https://github.com/PowerShell/vscode-powershell/issues/2881)](https://github.com/PowerShell/vscode-powershell/pull/2881) -
  Remove UTF-8 BOM from misc text files. (Thanks @xtqqczze!)
- 👷✨ [vscode-powershell [#2876](https://github.com/PowerShell/vscode-powershell/issues/2876)](https://github.com/PowerShell/vscode-powershell/pull/2876) -
  Update text in LICENSE.txt. (Thanks @xtqqczze!)
- 📺✨ [vscode-powershell [#2861](https://github.com/PowerShell/vscode-powershell/issues/2861)](https://github.com/PowerShell/vscode-powershell/pull/2861) -
  Update LSP Client to use new Semantic Highlighting APIs. (Thanks @justinytchen!)
- 👷✨ [vscode-powershell [#2871](https://github.com/PowerShell/vscode-powershell/issues/2871)](https://github.com/PowerShell/vscode-powershell/pull/2871) -
  Prevent `Update Notebook dts` action from triggering on forked repositories. (Thanks @corbob!)
- 🔧🐛 [vscode-powershell [#2863](https://github.com/PowerShell/vscode-powershell/issues/2863)](https://github.com/PowerShell/vscode-powershell/pull/2863) -
  Fix migration of `codeFormatting.addWhitespaceAroundPipe` setting when it doesn't already exist.
- 📺🐛 [vscode-powershell [#2845](https://github.com/PowerShell/vscode-powershell/issues/2845)](https://github.com/PowerShell/vscode-powershell/pull/2848) -
  Handle block comments with text on the same line as <# #> in Notebook Mode.
- ✨ [vscode-powershell [#2855](https://github.com/PowerShell/vscode-powershell/issues/2855)](https://github.com/PowerShell/vscode-powershell/pull/2855) -
  Expose the extension integration API via exports instead of editor commands.
- 📺✨ [vscode-powershell [#2844](https://github.com/PowerShell/vscode-powershell/issues/2844)](https://github.com/PowerShell/vscode-powershell/pull/2844) -
  Use property scope in the PowerShell ISE theme for better Semantic Highlighting.

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 🧠✨ [vscode-powershell [#2898](https://github.com/PowerShell/vscode-powershell/issues/2898)](https://github.com/PowerShell/PowerShellEditorServices/pull/1352) -
  Type and Namespace completions now have tooltips. (Thanks @AspenForester!)
- 🛫🐛 [vscode-powershell [#2719](https://github.com/PowerShell/vscode-powershell/issues/2719)](https://github.com/PowerShell/PowerShellEditorServices/pull/1349) -
  Fix startup assembly version loading issue in PowerShell 6 and up.
- 🔗🐛 [vscode-powershell [#2810](https://github.com/PowerShell/vscode-powershell/issues/2810)](https://github.com/PowerShell/PowerShellEditorServices/pull/1348) -
  Fix reference number on Windows due to directory separator difference on Windows.
- 📺✨ [PowerShellEditorServices [#1343](https://github.com/PowerShell/vscode-powershell/issues/1343)](https://github.com/PowerShell/PowerShellEditorServices/pull/1343) -
  Updated Semantic Handler to work with new LSP APIs. (Thanks @justinytchen!)
- 📺✨ [PowerShellEditorServices [#1337](https://github.com/PowerShell/vscode-powershell/issues/1337)](https://github.com/PowerShell/PowerShellEditorServices/pull/1337) -
...
- 📺✨ [vscode-powershell [#2834](https://github.com/PowerShell/vscode-powershell/issues/2834)](https://github.com/PowerShell/vscode-powershell/pull/2834) -
  Enable LSP proposed features for Semantic Highlighting. Also allow the PowerShell ISE theme to use Semantic Highlighting.
- 👮✨ [vscode-powershell [#2831](https://github.com/PowerShell/vscode-powershell/issues/2831)](https://github.com/PowerShell/vscode-powershell/pull/2831) -
...
- 📺✨ [vscode-powershell [#2789](https://github.com/PowerShell/vscode-powershell/issues/2789)](https://github.com/PowerShell/vscode-powershell/pull/2789) -
  Initial Notebook UI Mode in VS Code Insiders.
- 🔧✨ [vscode-powershell [#2693](https://github.com/PowerShell/vscode-powershell/issues/2693)](https://github.com/PowerShell/vscode-powershell/pull/2830) -
...
- 🧹✨ [vscode-powershell [#2685](https://github.com/PowerShell/vscode-powershell/issues/2685)](https://github.com/PowerShell/vscode-powershell/pull/2685) -
...
- ✨ [vscode-powershell [#2799](https://github.com/PowerShell/vscode-powershell/issues/2799)](https://github.com/PowerShell/vscode-powershell/pull/2799) -
  Initial VSCode-extension-facing PowerShell API: registering, unregistering, and getting PowerShell version details.
- 🛫✨ [vscode-powershell [#2796](https://github.com/PowerShell/vscode-powershell/issues/2796)](https://github.com/PowerShell/vscode-powershell/pull/2796) -
  Add setting to change the cwd of the Powershell Integrated Console. (Thanks @jwfx!)
- 🛫🐛 [vscode-powershell [#2780](https://github.com/PowerShell/vscode-powershell/issues/2780)](https://github.com/PowerShell/vscode-powershell/pull/2788) -
  Fix quoting of banner for global tool.
- 🔍🐛 [vscode-powershell [#2765](https://github.com/PowerShell/vscode-powershell/issues/2765)](https://github.com/PowerShell/vscode-powershell/pull/2775) -
  Emit 'terminated' event if PSES is restarted.

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 📺✨ [PowerShellEditorServices [#1328](https://github.com/PowerShell/vscode-powershell/issues/1328)](https://github.com/PowerShell/PowerShellEditorServices/pull/1328) -
  Enable handlers for Semantic Highlighting for better highlighting accuracy.
- 👮✨ [PowerShellEditorServices [#1333](https://github.com/PowerShell/vscode-powershell/issues/1333)](https://github.com/PowerShell/PowerShellEditorServices/pull/1333) -
  Expose new rule PSAvoidUsingDoubleQuotesForConstantString added in PSScriptAnalyzer 1.19.1. (Thanks @bergmeister!)
- 📺✨ [PowerShellEditorServices [#1321](https://github.com/PowerShell/vscode-powershell/issues/1321)](https://github.com/PowerShell/PowerShellEditorServices/pull/1321) -
  Needed changes for Notebook UI Support.
- 🛫✨ [PowerShellEditorServices [#1323](https://github.com/PowerShell/vscode-powershell/issues/1323)](https://github.com/PowerShell/PowerShellEditorServices/pull/1323) -
  Add cwd property to settings. (Thanks @jwfx!)
- 🛫🐛 [PowerShellEditorServices [#1317](https://github.com/PowerShell/vscode-powershell/issues/1317)](https://github.com/PowerShell/PowerShellEditorServices/pull/1318) -
  Move tests to PS7 and PS7.1 and fix IsNetCore check.
- 🔗✨ [PowerShellEditorServices [#1316](https://github.com/PowerShell/vscode-powershell/issues/1316)](https://github.com/PowerShell/PowerShellEditorServices/pull/1316) -
  Return null when Hover request is cancelled or no symbol details. (Thanks @ralish!)
- 🛫🐛 [vscode-powershell [#2763](https://github.com/PowerShell/vscode-powershell/issues/2763)](https://github.com/PowerShell/PowerShellEditorServices/pull/1315) -
...
- 👷 ✨ [vscode-powershell [#2740](https://github.com/PowerShell/vscode-powershell/issues/2740)](https://github.com/PowerShell/vscode-powershell/pull/2740) -
  Add CodeQL security scanning. (Thanks @jhutchings1!)

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 🔗 🐛 [PowerShellEditorServices [#1304](https://github.com/PowerShell/vscode-powershell/issues/1304)](https://github.com/PowerShell/PowerShellEditorServices/pull/1304) -
  Use From instead of FromFileSystem fixing CodeLens references.
- 📟 ✨ [PowerShellEditorServices [#1290](https://github.com/PowerShell/vscode-powershell/issues/1290)](https://github.com/PowerShell/PowerShellEditorServices/pull/1290) -
...
- 🐢✨ [vscode-powershell [#2730](https://github.com/PowerShell/vscode-powershell/issues/2730)](https://github.com/PowerShell/vscode-powershell/pull/2730) -
  Support adding an `OutputFile` and allow running Pester tests from the command pallet.
- 🔗🐛 [vscode-powershell [#2705](https://github.com/PowerShell/vscode-powershell/issues/2705)](https://github.com/PowerShell/vscode-powershell/pull/2705) -
  Tweak CodeLens logic now that we use Omnisharp's serializer.
- 📺✨ [vscode-powershell [#2702](https://github.com/PowerShell/vscode-powershell/issues/2702)](https://github.com/PowerShell/vscode-powershell/pull/2702) -
  Add coloring for `$` and remove it from `wordSepartors`. (Thanks @MJECloud!)
- 📺✨ [vscode-powershell [#2704](https://github.com/PowerShell/vscode-powershell/issues/2704)](https://github.com/PowerShell/vscode-powershell/pull/2704) -
  Add buttons for moving the terminal pane around. (Thanks @MartinGC94!)
- 👮‍🐛 [vscode-powershell [#2703](https://github.com/PowerShell/vscode-powershell/issues/2703)](https://github.com/PowerShell/vscode-powershell/pull/2703) -
  Tweak `whitespaceAroundPipe` settings migration logic to do it only once. (Thanks @bergmeister!)
- 👮‍🐛 [vscode-powershell [#2698](https://github.com/PowerShell/vscode-powershell/issues/2698)](https://github.com/PowerShell/vscode-powershell/pull/2698) -
...
- 🚂✨ [PowerShellEditorServices [#1301](https://github.com/PowerShell/vscode-powershell/issues/1301)](https://github.com/PowerShell/PowerShellEditorServices/pull/1301) -
  Fix `AddLanguageProtocolLogging` OmniSharp breaking change.
- 🚨✨ [PowerShellEditorServices [#1298](https://github.com/PowerShell/vscode-powershell/issues/1298)](https://github.com/PowerShell/PowerShellEditorServices/pull/1298) -
...
- 🚂✨ [PowerShellEditorServices [#1300](https://github.com/PowerShell/vscode-powershell/issues/1300)](https://github.com/PowerShell/PowerShellEditorServices/pull/1300) -
  Address breaking changes in Omnisharp lib and depend on `DocumentUri` more.
- 🚂✨ [PowerShellEditorServices [#1291](https://github.com/PowerShell/vscode-powershell/issues/1291)](https://github.com/PowerShell/PowerShellEditorServices/pull/1291) -
  Depend on `DocumentUri` for handing vscode `Uri`'s.
- 🧠✨ [vscode-powershell [#2706](https://github.com/PowerShell/vscode-powershell/issues/2706)](https://github.com/PowerShell/PowerShellEditorServices/pull/1294) -
...
- ✨🐢 [vscode-powershell [#2670](https://github.com/PowerShell/vscode-powershell/issues/2670)](https://github.com/PowerShell/vscode-powershell/pull/2670) -
  Add debug output setting for Pester. (Thanks @nohwnd!)
- ✨🔧 [vscode-powershell [#2689](https://github.com/PowerShell/vscode-powershell/issues/2689)](https://github.com/PowerShell/vscode-powershell/pull/2689) -
...
- 🐛🔧 [vscode-powershell [#2688](https://github.com/PowerShell/vscode-powershell/issues/2688)](https://github.com/PowerShell/vscode-powershell/pull/2688) -
  Respect user choice when dismissing the `powerShellExePath` dialog. (Thanks @bergmeister!)
- ✨👷 [vscode-powershell [#2686](https://github.com/PowerShell/vscode-powershell/issues/2686)](https://github.com/PowerShell/vscode-powershell/pull/2686) -
  Code clean up around some unused variables. (Thanks @bergmeister!)
- 🐛🐢 [vscode-powershell [#2676](https://github.com/PowerShell/vscode-powershell/issues/2676)](https://github.com/PowerShell/vscode-powershell/pull/2676) -
  Fix Pester invocation for 3x versions. (Thanks @nohwnd!)
- ✨👮‍ [vscode-powershell [#2674](https://github.com/PowerShell/vscode-powershell/issues/2674)](https://github.com/PowerShell/vscode-powershell/pull/2674) -
  Add additional settings for PSScriptAnalyzer 1.19. (Thanks @bergmeister!)
- ⚡️🔍 [vscode-powershell [#2672](https://github.com/PowerShell/vscode-powershell/issues/2672)](https://github.com/PowerShell/vscode-powershell/pull/2672) -
  Use in-memory debug adapter instead of spinning up new process.

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 🛫🐛 [PowerShellEditorServices [#1285](https://github.com/PowerShell/vscode-powershell/issues/1285)](https://github.com/PowerShell/PowerShellEditorServices/pull/1285) -
  Use API on ScriptBlock to generate PSCommand to run in ConstrainedLanguage mode.
- ⚡️🧠 [PowerShellEditorServices [#1283](https://github.com/PowerShell/vscode-powershell/issues/1283)](https://github.com/PowerShell/PowerShellEditorServices/pull/1283) -
  Move to Omnisharp lib 0.17.0 for increased performance.
- ✨👮 [PowerShellEditorServices [#1280](https://github.com/PowerShell/vscode-powershell/issues/1280)](https://github.com/PowerShell/PowerShellEditorServices/pull/1280) -
  Add additional settings for PSScriptAnalyzer 1.19. (Thanks @bergmeister!)
- 🔗 🐛 [vscode-powershell [#305](https://github.com/PowerShell/vscode-powershell/issues/305)](https://github.com/PowerShell/PowerShellEditorServices/pull/1279) -
  Fix document highlight column.
- 🐛🧠 [PowerShellEditorServices [#1276](https://github.com/PowerShell/vscode-powershell/issues/1276)](https://github.com/PowerShell/PowerShellEditorServices/pull/1276) -
...
- 🛫 ✨ [vscode-powershell [#2651](https://github.com/PowerShell/vscode-powershell/issues/2651)](https://github.com/PowerShell/vscode-powershell/pull/2651) -
  Add setting for the PackageManagement update feature.
- 👮‍ 🐛 [vscode-powershell [#2659](https://github.com/PowerShell/vscode-powershell/issues/2659)](https://github.com/PowerShell/vscode-powershell/pull/2659) -
  Remove broken 'Select PSScriptAnalyzer Rules' command. (Thanks @bergmeister!)
- 🛫 ✨ [vscode-powershell [#2526](https://github.com/PowerShell/vscode-powershell/issues/2526)](https://github.com/PowerShell/vscode-powershell/pull/2653) -
  Clean up WaitForSessionFile logic and support increasing timeout with warning.
- 📟 ✨ [vscode-powershell [#2644](https://github.com/PowerShell/vscode-powershell/issues/2644)](https://github.com/PowerShell/vscode-powershell/pull/2644) -
  Display preview state and version info in PSIC startup banner. (Thanks @rkeithhill!)
- 👷 ✨ [vscode-powershell [#2645](https://github.com/PowerShell/vscode-powershell/issues/2645)](https://github.com/PowerShell/vscode-powershell/pull/2645) -
  Add workspace file to load both vscode-powershell and PSES. (Thanks @rkeithhill!)

#### [PowerShellEditorServices](https://github.com/PowerShell/PowerShellEditorServices)

- 📟 🐛 [PowerShellEditorServices [#1272](https://github.com/PowerShell/vscode-powershell/issues/1272)](https://github.com/PowerShell/PowerShellEditorServices/pull/1272) -
  Allow progress colors to be settable and gettable from the internal host.
- 🛫 ✨ [PowerShellEditorServices [#1239](https://github.com/PowerShell/vscode-powershell/issues/1239)](https://github.com/PowerShell/PowerShellEditorServices/pull/1239) -
  Prompt to update PackageManagement when using an old version.
- 🛫 ✨ [PowerShellEditorServices [#1269](https://github.com/PowerShell/vscode-powershell/issues/1269)](https://github.com/PowerShell/PowerShellEditorServices/pull/1269) -
  Support ConstrainedLanguage mode.
- 📺 ✨ [PowerShellEditorServices [#1268](https://github.com/PowerShell/vscode-powershell/issues/1268)](https://github.com/PowerShell/PowerShellEditorServices/pull/1268) -
  Refactor GetCommandHandler to not use dynamic.
- 🔍 🐛 [vscode-powershell [#2654](https://github.com/PowerShell/vscode-powershell/issues/2654)](https://github.com/PowerShell/PowerShellEditorServices/pull/1270) -
  Fix interpolation in Log points, switch to double quotes. (Thanks @rkeithhill!)
- [PowerShellEditorServices [#1267](https://github.com/PowerShell/vscode-powershell/issues/1267)](https://github.com/PowerShell/PowerShellEditorServices/pull/1267) -
  Update module manifest to match current module.
- 📟 🐛 [vscode-powershell [#2637](https://github.com/PowerShell/vscode-powershell/issues/2637)](https://github.com/PowerShell/PowerShellEditorServices/pull/1264) -
  Leverage internal HostUI to check if VT100 is supported.
- 📟 🐛 [vscode-powershell [#2637](https://github.com/PowerShell/vscode-powershell/issues/2637)](https://github.com/PowerShell/PowerShellEditorServices/pull/1263) -
  Use stable builds of PSReadLine for the PowerShell extension and preview builds for the PowerShell Preview extension.
- 💎 ✨ [vscode-powershell [#2543](https://github.com/PowerShell/vscode-powershell/issues/2543)](https://github.com/PowerShell/PowerShellEditorServices/pull/1262) -
